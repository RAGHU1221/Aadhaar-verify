...
final Map<String, Map<String, String>> kStrings = {
  ...
  'field_registration_no': {'en': 'Registration Number', 'ta': 'பதிவு எண்'},
  ...
  'birth_cert_review': {'en': 'TN Birth Certificates have no national checksum - if the QR contains a crstn.org or Chennai GCC verify link, use \'Open Verify Link\' to confirm against the Civil Registration record. This app also cross-checks the QR link\'s own registration number against the number printed on the certificate, where possible.', 'ta': 'தமிழ்நாடு பிறப்பு சான்றிதழுக்கு தேசிய செக்சம் கிடையாது - QR-ல் crstn.org அல்லது Chennai GCC லிங்க் இருந்தால், \'Open Verify Link\' பயன்படுத்தி பதிவு துறையின் பதிவுடன் உறுதி செய்யவும். QR லிங்க்-ல் உள்ள பதிவு எண்ணையும் சான்றிதழில் அச்சிடப்பட்ட எண்ணுடன் முடிந்தவரை இந்த ஆப் ஒப்பிடுகிறது.'},
  'birth_cert_unclear': {'en': 'Could not read a clear registration number - manual check needed.', 'ta': 'பதிவு எண் தெளிவாக படிக்க முடியவில்லை - கைமுறை சோதனை தேவை.'},
  ...
  'url_verify_match': {'en': 'The QR verification link\'s own reference number ({qr_no}) MATCHES the number printed on the document. Since altering the printed number without also being able to regenerate a matching QR is hard, this is a meaningful tamper-resistance signal - still confirm via \'Open Verify Link\' for full certainty.', 'ta': 'QR சரிபார்ப்பு லிங்க்-ல் உள்ள எண் ({qr_no}) ஆவணத்தில் அச்சிடப்பட்ட எண்ணுடன் பொருந்துகிறது. இது ஆவணம் மாற்றப்படவில்லை என்பதற்கான ஒரு நல்ல அறிகுறி - முழு உறுதிக்கு \'Open Verify Link\' மூலம் சரிபார்க்கவும்.'},
  'url_verify_mismatch': {'en': 'The QR verification link\'s reference number ({qr_no}) does NOT match the number printed/read on the document ({printed_no}). This is a strong signal of tampering - flag for manual review before accepting.', 'ta': 'QR சரிபார்ப்பு லிங்க்-ல் உள்ள எண் ({qr_no}) ஆவணத்தில் அச்சிடப்பட்ட எண்ணுடன் ({printed_no}) பொருந்தவில்லை. இது ஆவணம் மாற்றப்பட்டிருக்கலாம் என்பதற்கான வலுவான அறிகுறி - ஏற்கும் முன் கைமுறையாக சரிபார்க்கவும்.'},
